...
module.exports.deleteJob = async (req, res, next) => {
  try {
    const jobId = req.params.id; // Assuming the job ID is provided in the URL parameter.
    ...
    // Assuming you also want to remove the job reference from the associated company.
    const Company = require("../model/CompanyModel");
