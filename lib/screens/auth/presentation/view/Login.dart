...
import 'package:jobhunt/screens/applicant/domin/controller/AppliedJobController.dart';
import 'package:jobhunt/core/shared_preference/LoginResponse.dart';
import 'package:jobhunt/screens/employer/data/model/Company.dart';
...
import 'package:jobhunt/screens/auth/presentation/view/OTPVerificationScreen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  getAppliedJobs() async {
    final JobsRepository jobRepository = JobsRepository();
    final appldJobs = await jobRepository.getAppliedJobs();
    final appliedJobs = appldJobs?.data;

    //store appliedJobs in sqlite db
    if (appliedJobs != null) {
      JobController jobHelper = JobController();
      jobHelper.deleteAll();
      for (var data in appliedJobs) {
        jobHelper.addAppliedJob(appliedJob: data);
      }
    }
  }
